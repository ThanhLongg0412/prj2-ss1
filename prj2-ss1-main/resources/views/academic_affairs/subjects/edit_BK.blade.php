            ...
            @foreach($subjects as $subject)
                <form action="{{ route('aa-subject-updateBK') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="number" min="1" max="10" class="form-control" name="exam_times" placeholder="Lần thi" value="{{ $subject->exam_times }}" autocomplete="off" style="margin-top: 20px" required>
